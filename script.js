const reasons = [
  ...
  "Because I wanted you to know that you were loved.",
  "Because I wanted you to know that you were appreciated.",
  "Because I wanted to give our memories a beautiful place to live.",
  "Because some feelings are impossible to put into a single sentence.",
  "Because some memories deserve more than a passing thought.",
  "Because some people become unforgettable without even trying.",
  "Because you became unforgettable to me.",
  "Because your place in my memories will always be special.",
  "Because I still remember the little things that made us smile.",
  "Because I still remember the moments that made my heart feel full.",
  "Because I still remember how beautiful it felt to care about you.",
  "Because I still remember the excitement of seeing your name.",
  "Because I still remember how much your messages meant.",
  "Because I still remember the comfort of our conversations.",
  "Because I still remember the happiness we created together.",
  "Because I still remember how much I wanted to make you happy.",
  "Because I still remember how special you made me feel.",
  "Because I still remember the person I became around you.",
  "Because I still remember how naturally you became important.",
  "Because I still remember the little universe we created together.",
  "Because I still remember the laughter.",
  "Because I still remember the silly moments.",
  "Because I still remember the serious conversations.",
  "Because I still remember the quiet moments.",
  "Because I still remember the feeling of being close.",
  "Because I still remember how much I cared.",
  "Because I still remember how much I loved.",
  "Because I still remember how much you meant to me.",
  "Because every chapter of our story taught me something.",
  "Because every memory became a part of who I am.",
  "Because every difficult moment taught me something I needed to learn.",
  "Because every beautiful moment reminded me why I cared.",
  "Because I’m grateful for every laugh.",
  "Because I’m grateful for every conversation.",
  "Because I’m grateful for every memory.",
  "Because I’m grateful for every little moment.",
  "Because I’m grateful that, for a while, our worlds met.",
  "Because after everything, I still wanted you to know how deeply you were loved.",

  " 365. ३६४ कारण लिहूणसुद्धा,मी तुझ्या वर का प्रेम करतो हे सांगता येणार नाही… कदाचित तुझ्यावर प्रेम करण्यासाठी मला कधी कारणांची गरज पडलीच नाही. मी फक्त तुझ्यावर प्रेम केल ♾️🤍. आणि नकळत कधी तू माझ्या आयुष्यातली सगळ्यात खास…आणि माझ्यासाठी सर्वात महत्वाची व्यक्ती बनली कळाल ही नाही ❤️‍🩹"
];
...
function renderReason(number) {
  reasonText.textContent = reasons[number - 1];

  reasonNumber.textContent = formatNumber(number);
  cardNumber.textContent = formatNumber(number);

  previousBtn.disabled = number === 1;

  if (number === 365) {
    nextBtn.innerHTML = 'Finish <span>♡</span>';

    bottomMessage.textContent =
      "And somehow… even 365 reasons weren't enough. ♾️";
  } else {
    nextBtn.innerHTML = 'Another reason <span>→</span>';

    const remaining = 365 - number;
    ...
    if (remaining === 1) {
      ...
      bottomMessage.textContent =
        `Keep going… there are ${remaining} more reasons waiting for you. 🤍`;
    }
  }
}


function updateReason(animate = true) {
  if (animate) {
    reasonCard.classList.add("changing");

    setTimeout(() => {
      renderReason(currentReason + 1);
